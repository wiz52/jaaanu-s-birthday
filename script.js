...
const SITE_CONTENT = {
  ...
  timeline: [
    ...
    { label: "now", date: "2026", title: "she is my everything", text: "And somehow, here we are — still choosing each other, distance and all." },
  ],
  ...
  // Q2 and Q3 still need real decoy options from you — see note below.
  quiz: [
    ...
    { question: "What song reminds us of each other?", options: ["Tum Se Hi", "[add a decoy song]", "[add a decoy song]"], answer: 0 },
    { question: "What do I always tease you about?", options: ["[add the real answer]", "[add a decoy]", "[add a decoy]"], answer: 0 },
  ],
